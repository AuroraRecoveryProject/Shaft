...
@inline(__always)
internal func sin(_ a: Float) -> Float { Bionic.sinf(a) }
@inline(__always)
internal func cos(_ a: Float) -> Float { Bionic.cosf(a) }
@inline(__always)
internal func tan(_ a: Float) -> Float { Bionic.tanf(a) }
@inline(__always)
internal func sqrt(_ a: Float) -> Float { Bionic.sqrtf(a) }
@inline(__always)
internal func powf(_ a: Float, _ b: Float) -> Float { Bionic.powf(a, b) }

#elseif canImport(Glibc)
import Glibc

@inline(__always)
internal func sin(_ a: Float) -> Float { Glibc.sinf(a) }
@inline(__always)
internal func cos(_ a: Float) -> Float { Glibc.cosf(a) }
@inline(__always)
internal func tan(_ a: Float) -> Float { Glibc.tanf(a) }
@inline(__always)
internal func sqrt(_ a: Float) -> Float { Glibc.sqrtf(a) }
